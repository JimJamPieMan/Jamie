/*TODO LIST
- make the change channel command work in other servers
- make sure some messages are thrown when things dont work
- tidy up the music command
- make it so when an unknown command is enterd it says whatever
*/
