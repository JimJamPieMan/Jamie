...
function play(connection, message) {
    ...
    server.dispatcher = connection.playStream(yt(server.queue[0], { filter:
    "audioonly" }));
...
message.author.sendMessage("a whhhholllle lotta help for you", { embed });
}
